...
export default function SignupPage() {
  ...
  async function handleSignup(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (authError) {
      setError(
        authError.message.includes("TRIAL_CAP_REACHED")
          ? "All 10,000 early-access slots are taken. Follow us for the public launch."
          : authError.message
      );
      return;
    }
          ...
          {done ? (
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-400">
                ...
                <span className="text-gray-200">{email}</span>. Click it, then
