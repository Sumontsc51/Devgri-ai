...
<div id="build">
  ...
  <div id="body">
    ...
    <div id="main">
      ...
      <div id="previewview">
        <div style="display:flex;justify-content:center;margin-bottom:12px;"><div class="seg"><button id="dDesk" class="on"><i class="ti ti-device-desktop" style="font-size:13px"></i> Desktop</button><button id="dMob"><i class="ti ti-device-mobile" style="font-size:13px"></i> Mobile</button></div></div>
        <div id="site">
          <div id="sitenav"></div>
          <div id="ptabs"></div>
          <div id="psecs"></div>
